        ...
        <div className="footer_box">
          <div className="footer_card1">
            ...
            <div className="footer_location">
              ...
              <p className="footer_location_text">
                Jizzax shahri Olmazor mahallasi <br />
                Mustaqillik koʻchasi 58-uy
              </p>
            </div>
          ...
          <div className="footer_card2">
            <div >
            <iframe className="map_container" src="https://yandex.com/map-widget/v1/?um=constructor%3A9624e84f32a1cc435a2b2403cefbeb0d8375f9a657505f8e80805202c236c649&amp;source=constructor" width="907" height="444" frameborder="0"></iframe>
            </div>
          </div>
